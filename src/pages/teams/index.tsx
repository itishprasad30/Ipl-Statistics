  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <Header
          content="Teams"
          description="click on the card to view individual stats"
        />
        {/* <Navigation home="/" goBack="/" /> */}
        <div className={styles.grid}>
          {data.map((team, id) => (
            <Link key={id} href={`/teams-statistics/${team.team1}`}>
...
// geting from server side res in nextjs feature of Ssr
